//! Upstream `scaffl-agents.toml` manifest types.
//!
...
//! relaxes scaffl's normal whole-file ownership for seed files.

use crate::error::AgentsError;
use serde::{Deserialize, Serialize};
use std::path::{Component, Path, PathBuf};

/// Wire form of `scaffl-agents.toml`.
...
mod tests {
    ...
    fn parses_minimal_manifest() {
        let raw = r#"
            ...
            dest = ".claude/skills/"
        "#;
        let m = parse_manifest(Path::new("scaffl-agents.toml"), raw).unwrap();
