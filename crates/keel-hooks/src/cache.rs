...
use keel_cache::{CacheError, CacheKind, RepoRef};

pub use keel_cache::{CacheMeta, CachedRepo};
...
pub fn cache_root(project_root: &std::path::Path) -> std::path::PathBuf {
    keel_cache::cache_root(project_root, CacheKind::Hooks)
}
