...
//! `CustomEntry` shape that `keel_container::custom::CustomBackend`
...
use keel_config::{CustomService, SystemdScope, SystemdService};
use keel_container::custom::CustomEntry;
