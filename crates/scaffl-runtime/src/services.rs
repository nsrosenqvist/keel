//! Translators from `scaffl-config` service declarations into the
//! `CustomEntry` shape that `scaffl_container::custom::CustomBackend`
...
use scaffl_config::{CustomService, SystemdScope, SystemdService};
use scaffl_container::custom::CustomEntry;
