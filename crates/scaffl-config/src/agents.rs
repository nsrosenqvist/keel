...
//! The actual cache + apply pipeline lives in `scaffl-agents`.

use serde::Deserialize;

const DEFAULT_MANIFEST_PATH: &str = "scaffl-agents.toml";
...
pub struct AgentsConfig {
    /// When true (default), `scaffl install` runs `scaffl agents
...
impl AgentsConfig {
    ...
    /// shape. Called from [`crate::Config::validate`].
