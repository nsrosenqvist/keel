...
pub const GITHUB_RELEASES_ALL_API: &str = "https://api.github.com/repos/nsrosenqvist/keel/releases";

pub fn release_asset_url(tag: &str, target: &str) -> String {
    format!("https://github.com/nsrosenqvist/keel/releases/download/{tag}/keel-{target}.tar.gz")
}
